...
//cliente
export * from './datasources/cliente.datasource.impl'
export * from './repositories/cliente.repository.impl'

//ubicacion
export * from './datasources/ubicacion.datasource.impl'
export * from './repositories/ubicacion.repository.impl'

//inmueble
export * from './datasources/inmueble.datasource.impl'
export * from './repositories/inmueble.repository.impl'
